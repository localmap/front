...
const Choose_food: React.FC = () => {
  ...
  return (
    <div className="choose_food">
      <p>음식종류</p>
      <section className="food_wraps">
        <section className="food_list">
          <button
            className="food1_button"
        ...
        <section className="food_list2">
          <button
            className="food5_button"
