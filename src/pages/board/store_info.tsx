...
const Store_info: React.FC = () => {
  return (
    <div className="store_info">
      <Review_picture />
      <main className="store_info_main">
        <div className="main_content">
          <div className="store_title">
            <div className="title_wrap">
              음식점 이름 <strong>별점</strong>
            </div>
          ...
          <div className="event_wraps">
            ...
            <div className="event_content">
              이벤트내용 : 음식을 먹고 사진과 함께 리뷰를 남겨주시는 분들께
              사이드메뉴를 드립니다.
              <p>1. 소떡소떡</p>
              <p>2. 사이다 355ml캔</p>
              <p>3. 콜라 355ml 캔</p>
        ...
        <aside className="right_area">
          ...
          <div className="popular_list">
            <div className="popular_1_wrap">
              ...
              <p>
                양고기맛집(성수점)<strong>4.6</strong>
              </p>
              <span>성수역 - 기타 중식</span>
              <br />
              <img className="info_img"></img>
              <span>65,001</span>
              <img className="info_img2"></img>
              <span>36</span>
            </div>
          </div>
      ...
      <footer className="review_wraps">
        <div className="review_title">
          <div>리뷰 (해당 식당리뷰숫자) </div>
          <div>리뷰전체 / 리뷰순으로 정렬</div>
        </div>
