        ...
        <div className='editor_info'>
            <div className='column_title'>
                ...
                <div className='group_wraps'>
                    ...
                    <div className='btn_wraps'>
                        <button><img className='heart_logo' src='https://cdn-icons-png.flaticon.com/128/1077/1077035.png'></img></button>
                        <button><img className='shaer_logo ' src='https://cdn-icons-png.flaticon.com/128/1358/1358023.png'></img></button>
                    </div>
                </div>
                <hr />
            </div>
            <div className='column_content'>
                <div className='sub_title'>
                    <strong><p>더운 여름날을 책임 질 보양식! 뜨끈함으로 더위를 잡아낼수있는 맛집을 소개합니다.</p>
                        시원함을 경험하고 싶은 분들에게는 안성맞춤 맛집! 모두 체험해보세요.
                    </strong>
                    <div className='column_writer'>
                        칼럼리스트 : 김세훈
                    </div>
                </div>
                <p>
                    <p>사계절이 뚜렷한 농경사회였던 우리나라는 '복날'을 챙기는 풍습이있다.</p>
                    <p>'절기' 개념을 농사헤 활용하던 시대는 지났지만, 자연의 주기에 맞춰 생활양식을 조절하던
                        문화는 뿌리깊숙히 남아있다.
                    </p>
                    <p>
                        초복,중복,말복의 삼복은 여름철 대표 절기다. 삼복기간은 여름중에서도 가장 더운시기로 꼽힌다.
                    </p>
                </p>
                ...
                <div className='food_info'>
                    ...
                    <p>남녀노소 가라지않고 즐겨먹으며 쉽게 접할수있다는 점이 장점이다.
                    </p>
                    <p>
                        이번 여름 장마도길어지고, 역대급 더위라고하는데
                        보양식으로 몸보신하여 무덥고 습한여름을 잘 헤쳐나갔으면 좋겠다.
                    </p>
                </div>
                <div className='columnist_wraps'>
                    <div className='columnist'>
                        <div className='columnist_picture'>
                            <img className='columnlist_img' src='https://images.unsplash.com/photo-1627796795540-18e2db6d3908?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8JUVDJThBJUE0JUVEJThFJTgwJUVDJUE3JTgwJUVCJUIwJUE1fGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60'></img>
                        </div>
