                ...
                <Stack direction='column'width='48%'>
                    ...
                    <Stack direction='column' sx={{marginTop:5}}>
                        ...
                        <Stack direction='column' sx={{mt:2}}>
                            ...
                            <Box sx={{color:"#7F7F7F", display:'flex' , justifyContent:'left' , alignItems:'left'}}>
                        ...
                        <Stack direction='column' className="list-items" sx={{mt:2}}>
                                <Typography sx={{fontWeight:'bold'}}>* 유의사항(꼭1 확인해주세요)</Typography>
                        ...
                        <Stack direction='column' className="list-items">
                            <Typography sx={{fontWeight:'bold'}}> * 사용 방법</Typography>
                            <ul style={{color:"#7F7F7F"}}>
                                <li> 구매하신 EAT딜은 최신 버전 앱에서만 사용 가능합니다.</li>
                                <li> 결제 시 로컬맵  내정보  구매한 EAT딜을 선택하여 매장에 비치된 QR코드를 스캔합니다.</li>
